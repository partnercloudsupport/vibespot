...
import 'package:vibespot/src/models/signup_model_artist.dart';

class SignUpArtistPage extends StatefulWidget {
  createState() {
    return SignUpArtistPageState();
  }
}



class SignUpArtistPageState extends State<SignUpArtistPage> with ValidationMixin {

  SignUpModelArtist user;
  ...
  final TextEditingController _artistNameController = new TextEditingController();
